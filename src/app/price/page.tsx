...
const FreePlanSection = ({ isMonthly }: { isMonthly: boolean }) => {
  ...
  return (
    <div className="bg-Grey-900 px-16 py-9 w-full flex justify-between mt-9 mb-5 rounded-lg">
      ...
      <div className="flex">
        ...
        <div className="bg-Grey-600 w-px h-full mr-6" />
        <div className="flex flex-col">
...
const ReviewSection = () => (
  <section className="flex flex-col items-center mb-48">
    <div className="font-calSans text-[3rem] mb-6">See Why People Like Us</div>
    <div className="flex gap-4 pl-6 mb-[3.25rem] Subhead_1_semibold text-Grey-400 items-center">
      ...
      >
        <div className="px-[6.12rem]">
          <section className="flex flex-col items-center pt-[7.5rem]">
            <div className="text-center font-calSans text-[3rem] mb-5">
              Choose a Plan
            </div>
          ...
          <SectionWrapper>
            <section className="flex mb-44">
              <div className="font-calSans text-5xl whitespace-nowrap">
                StudioX FAQ
              </div>
          ...
          <section className="font-calSans text-[4rem] flex flex-col gap-7 items-center mb-[17.5rem]">
