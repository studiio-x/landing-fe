...
const SvgProfileDefault = ({
  ...
  >
    ...
    <circle
      ...
      cy={36}
      r={35.5}
      fill="url(#profile-default_svg__a)"
      stroke="#626B7F"
    />
    <defs>
      <pattern
        id="profile-default_svg__a"
        width={1}
        height={1}
        patternContentUnits="objectBoundingBox"
      >
        <use xlinkHref="#profile-default_svg__b" transform="scale(.0039)" />
      </pattern>
      <image
...
const Memo = memo(SvgProfileDefault);
export default Memo;
